...
public class SPH_Compute : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        int threadGroupSize = Mathf.Max(1, num / 100);
shader.Dispatch(densityPressureKernel, threadGroupSize, 1, 1);
shader.Dispatch(computeForceKernel, threadGroupSize, 1, 1);
shader.Dispatch(integrateKernel, threadGroupSize, 1, 1);
